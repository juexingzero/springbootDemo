...
import com.demo.shiro.listener.ShiroSessionListener;
 ...
 *
 * @author 陈智颖
 * @create 2018-07-31 下午3:47
 **/
@Configuration
public class ShiroConfig {

    @Resource
    private com.demo.shiro.FebsProperies febsProperies;
    ...
    private RedisManager redisManager() {
        ...
        // 缓存时间，单位为秒
        redisManager.setTimeout(febsProperies.getShiro().getTimeout());
